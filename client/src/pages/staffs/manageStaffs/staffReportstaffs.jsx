...
// --- CustomDoughnutChart Component (ensure this is the updated version) ---
...
CustomDoughnutChart.propTypes = {
  ...
  children: PropTypes.node, // Ensure this is present
};
...
const StaffReports = () => {
  ...
  return (
    <div className="min-h-screen ">
      {/* Remove max-w-7xl here to allow the page to expand on zoom out */}
      <div className="mx-auto w-full px-6 py-10"> {/* Added w-full for consistent behavior */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <motion.div
            className="bg-white p-6 rounded-2xl shadow-lg flex flex-col items-center relative h-[300px]" // Added h-[300px] for consistent height
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          >
            ...
            {/* This div now acts as the flex container for the chart and the legend */}
            <div className="flex w-full justify-center items-center h-full">
              <CustomDoughnutChart
                ...
                gapDegrees={3}
              >
                {/* Center Text for Completion Percentage - NOW A CHILD OF CustomDoughnutChart */}
                <div
          ...
          {/* Attendance Chart */}
          <motion.div
            className="bg-white rounded-2xl p-6 shadow-md flex flex-col h-[300px]" // Added h-[300px] for consistent height
        ...
        <div className="flex flex-col sm:flex-row justify-end items-center space-y-3 sm:space-y-0 sm:space-x-4 mt-8">
          <select
            value={selectedMonth}
